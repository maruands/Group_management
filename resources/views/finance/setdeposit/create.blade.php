    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card m-3">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('setdeposit.store') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="start_date" type="date" class="form-control @error('start_date') is-invalid @enderror" name="start_date" value="" required autocomplete="start_date" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="end_date" type="date" class="form-control @error('end_date') is-invalid @enderror" name="end_date" value="" required autocomplete="end_date" autofocus>
